...
To complete the CLI tutorials and walkthroughs, you must provision a Data Science Virtual Machine (DSVM). If you have not yet provisioned a DSVM, see [Readme](https://aka.ms/o16ncli) for this repository.
...
The To test the web service on the cluster run the python script:
	...
	python score_cntk.py --img car.png --url http://<your service URL>:<port number>/score --name <your service name>
